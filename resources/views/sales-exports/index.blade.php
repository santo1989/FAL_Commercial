            ...
            <div class="card-header bg-success text-white">
                <div class="d-flex flex-row flex-wrap align-items-center justify-content-between gap-2">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        @can('Export-CURD')
                            <a href="{{ route('sales-exports.export') }}{{ request()->getQueryString() ? '?' . request()->getQueryString() : '' }}" class="btn btn-light me-2" title="Export filtered exports to Excel">
                                <i class="fas fa-file-excel"></i>
                            </a>
                            <a href="{{ route('sales-exports.pdf') }}{{ request()->getQueryString() ? '?' . request()->getQueryString() : '' }}" class="btn btn-danger" title="Download PDF of filtered exports">
